...
public class StatisticClient extends BaseClient {
    ...
    @Autowired
    public StatisticClient(@Value("${stats-service.url}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
    ...
    public ResponseEntity<Object> postEndpointHit(StatisticInDto hitRequestDto) {
    ...
    public List<StatisticViewDto> getStatistic(LocalDateTime start, LocalDateTime end,
        ...
        ResponseEntity<List<StatisticViewDto>> response = rest.exchange(API_PREFIX_START + query,
                HttpMethod.GET, null,
                new ParameterizedTypeReference<>() {
                }, parameters);
        List<StatisticViewDto> result = response.getBody();
